package com.yincy.boot.framework.swagger.config;
...
import static com.yincy.boot.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class YincySwaggerAutoConfiguration {
